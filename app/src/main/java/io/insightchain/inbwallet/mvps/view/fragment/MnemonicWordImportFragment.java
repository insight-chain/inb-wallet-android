...
public class MnemonicWordImportFragment extends BaseMvpFragment implements ImportWalletView {
    ...
    public static MnemonicWordImportFragment newInstance(){
//        MnemonicWordImportFragment fragment = new MnemonicWordImportFragment();
        return new MnemonicWordImportFragment();
    }
