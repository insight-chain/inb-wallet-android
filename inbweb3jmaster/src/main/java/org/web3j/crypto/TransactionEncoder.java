...
////        result.add(RlpString.create(rawTransaction.getResourcePayer()));
//                list.add(RlpString.create(rawTransaction.getResourcePayer()));
//                list.add(RlpString.create(rawTransaction.getVp()));
//            list.add(RlpString.create(Bytes.trimLeadingZeroes(rawTransaction.getRp())));
//            list.add(RlpString.create(Bytes.trimLeadingZeroes(rawTransaction.getSp())));
//            RlpList rlpList = new RlpList(list);
//            result.add(rlpList);

//        result.add(RlpString.create(rawTransaction.getResourcePayer()));
//        result.add(RlpString.create(rawTransaction.getVp()));
//        result.add(RlpString.create(Bytes.trimLeadingZeroes(rawTransaction.getRp())));
//        result.add(RlpString.create(Bytes.trimLeadingZeroes(rawTransaction.getSp())));
        return result;
    }
}
